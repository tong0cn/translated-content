...
- _id_
  - : 用作背景元素的 ID，使用元素上的 HTML 属性 #_id_ 指定。
...
ID为“myBackground1”的 {{HTMLElement("div")}} 元素用作包含段落“This box uses the element with the #myBackground1 ID as its background!”的内容的背景。
